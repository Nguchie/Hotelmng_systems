...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2024 at 05:05 PM
...
CREATE TABLE `clients` (
  ...
  `client_phone_no` int(11) NOT NULL,
...
INSERT INTO `clients` (`client_id`, `client_name`, `client_gender`, `client_age`, `client_phone_no`, `client_country`) VALUES
(1, 'rack', 'Male', 44, 34567, 'Afghanistan');
